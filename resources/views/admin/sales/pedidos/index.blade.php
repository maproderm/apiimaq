                ...
                <div class="d-flex p-5">
                    <div class="col-md-4 my-2 my-md-0">
                        <div class="input-icon">
                            <input type="text" class="form-control" placeholder="Buscar pedido" id="filter_client_name"/>
                            <span>
                    ...
                    <div class="col-md-6 my-2 my-md-0 d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        <img src="{{  asset('metronic/assets/media/logos/header.jpg')  }}" alt="" width="400" height="60">
                    </div>
                </div>
                <!--begin::Datatable-->
