<div class="modal fade" id="kt_modal_update_category_mpd" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-body pt-0 pb-15 px-5 px-xl-20">
                ...
                <div class="card-body pt-5">
                    ...
                    <form id="kt_ecommerce_settings_general_form" class="form" action="{{  route('catalogmpd.categories.update',[$data->category->id])  }}" method="POST">
                        @csrf
                        @method('PATCH')
                        <!--begin::Row-->
                                    ...
                                    <div class="input-group flex-nowrap">
                                        ...
                                        <div class="overflow-hidden flex-grow-1">
                                            <select class="form-select" data-control="select2" data-placeholder="Selecciona una opción" name="division_id">
                                                ...
                                                <option
                                                    @isset($data->category)
                                                        @if ($data->category->division_id == $division->id)
                                                        selected
                                                        @endif
                                                    @endisset
                                                    name="division_id"
