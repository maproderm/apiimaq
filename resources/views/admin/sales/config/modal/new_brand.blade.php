        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-body pt-0 pb-15 px-5 px-xl-20">
                ...
                <div class="card-body pt-5">
                    ...
                    <form id="kt_ecommerce_settings_general_form" class="form" action="{{  route('catalogmpd.brands.store')  }}" method="POST">
                        @csrf
                        <!--begin::Row-->
                        <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                            ...
                            <div class="col">
                                ...
                                <div class="fv-row mb-5">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control" name="description_brand" value="" required placeholder="Nombre de la marca" autocomplete="off" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
