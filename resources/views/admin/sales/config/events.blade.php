...
@section('title','Eventos | MaProDerm')
@section('content')
            ...
            <div class="card-body">
                <div class="d-flex p-5">
                    ...
                    <div class=" col-md-8 my-2 my-md-0 d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        <!--begin::Add customer-->
                        <button type="button" class="btn btn-light-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_new_event">Nuevo Evento</button>
                        <!--end::Add customer-->
                    </div>
                    <!--end::Toolbar-->
                </div>
...
@include('admin.sales.config.modal.new_event')
<div id="edit_event_mpd_modal"></div>
@endsection
@push('scripts')
    <script type="text/javascript" src="{{  URL::asset ('js/admin/sales/config/events.js?v='.rand())  }}"></script>
@endpush
