            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                ...
                <form id="kt_modal_new_target_form" class="form" action="{{  route('productos.mapro.update',[$data->product->id])  }}" method="POST">
                    ...
                    <div class="mb-7">
                        ...
                        <div class="mt-1">
                            ...
                            <div class="image-input image-input-outline image-input-placeholder image-input-empty" data-kt-image-input="true">
                                ...
                                <div class="image-input-wrapper w-100px h-100px" style="background-image: url('{{ asset(ltrim($data->product->image, '/')) }}')"></div>
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <!--begin::Col-->
                        <div class="col-md-6 fv-row">
                            <label class="required fs-6 fw-semibold mb-2">GS1</label>
                            ...
                            <div class="input-group mb-5">
                                ...
                                <!--<input type="text" style="text-transform:uppercase" class="form-control" name="barcode_product_inventory" value="{{ $data->product->barcode_product_inventory ?? '' }}" required/> -->
                                <input type="text" style="text-transform:uppercase" class="form-control" name="barcode_product_inventory" value="{{ isset($data->product->barcode_product_inventory) && $data->product->barcode_product_inventory >= 5000 ? $data->product->barcode_product_inventory : 'No asignado' }}" required/>
                            ...
                            <div class="input-group mb-5">
                                ...
                                <!-- <input type="text" style="text-transform:uppercase" class="form-control" name="barcode_product_inventory" value="{{ $data->product->barcode_product_inventory ?? '' }}" required disabled/> -->

                                <!--
                                    CON ESTA OPCIÓN SE MUESTRA EL CODIGO GS1 SI ES QUE HAY VALORES MAYOR A 5000 SINO APARECERA QUE NO TIENE GS1 ASIGNADO
                                    ESTA OPCION SOLO APARECERÁ PARA LOS ROLES DE ACONCIONADO
                                -->
                                <input type="text" style="text-transform:uppercase" class="form-control" name="barcode_product_inventory" value="{{ isset($data->product->barcode_product_inventory) && $data->product->barcode_product_inventory >= 5000 ? $data->product->barcode_product_inventory : 'No asignado' }}" required disabled/>
                            </div>
                            @endhasanyrole
                            <!--end::Input-->
                        </div>
