...
@section('title','Empresa | IMAQ | MaProDerm')
@section('content')
            ...
            <div class="card-body">
                <div class="d-flex p-5">
                    ...
                    {{-- <div class=" col-md-8 my-2 my-md-0 d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        <button type="button" class="btn btn-light-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_new_brand_imaq">Nueva Marca</button>
                    </div> --}}
                </div>
                <!--begin::Datatable-->
...
{{-- @include('admin.warehouseimaq.catalog.brand.modal.new_brand') --}}
<div id="edit_business_imaq_modal"></div>
@endsection
@push('scripts')
    <script type="text/javascript" src="{{  URL::asset ('js/admin/security/business.js?v='.rand())  }}"></script>
@endpush
