                ...
                <div class="col-xl-12">
                    ...
                    <div class="card card-flush h-lg-100" id="kt_contacts_main">
                        ...
                        <div class="card-body pt-5">
                            ...
                            <form id="kt_ecommerce_settings_general_form" class="form" action="{{  route('productos.mapro.store')  }}" method="POST">
                                @csrf
                                ...
                                <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="fv-row mb-5">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" class="form-control" name="name_product_inventory" value="" autocomplete="off" required/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <div class="input-group mb-5">
                                                ...
                                                <input type="text" style="text-transform:uppercase" class="form-control" name="sku_product_inventory" value="" autocomplete="off" required/>
                                            </div>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <div class="input-group mb-5">
                                                ...
                                                <input type="text" style="text-transform:uppercase" class="form-control" name="barcode_product_inventory" value="" autocomplete="off" required/>
                                            </div>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                ...
                                <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <div class="input-group mb-5">
                                                <span class="input-group-text">$</span>
                                                <input id="number" type="number" class="form-control" step=".01" name="price_product_inventory" value=""/>
                                            </div>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
