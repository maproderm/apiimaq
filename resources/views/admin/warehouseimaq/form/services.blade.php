...
@section('title','Servicios Mi Marca | IMAQ')
@section('content')
...
<div class="" id="edit_status_service_modal"></div>
@endsection
@push('scripts')
    <script type="text/javascript" src="{{  URL::asset ('js/admin/warehouseimaq/formimaq/service_form_imaq.js?v='.rand())  }}"></script>
@endpush
