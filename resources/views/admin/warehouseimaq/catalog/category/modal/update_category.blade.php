<div class="modal fade" id="kt_modal_update_category_imaq" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <!--begin::Modal dialog-->
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-body pt-0 pb-15 px-5 px-xl-20">
                ...
                <div class="card-body pt-5">
                    ...
                    <form id="kt_ecommerce_settings_general_form" class="form" action="{{  route('catalogimaq.category.update',[$data->category->id])  }}" method="POST">
                        @csrf
                        @method('PATCH')
                        <!--begin::Row-->
