...
@section('title','Unidad de Medida | IMAQ')
@section('content')
                ...
                <div class="d-flex p-5">
                    <div class="col-md-4 my-2 my-md-0">
                        <div class="input-icon">
                            <input type="text" class="form-control" placeholder="Buscar unidad de medida" id="filter_client_name"/>
                            <span>
                    ...
                    <div class=" col-md-8 my-2 my-md-0 d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        <button type="button" class="btn btn-light-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_new_measurement_imaq">Agregar</button>
                    </div>
                </div>
                <!--begin::Datatable-->
