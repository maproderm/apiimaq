            ...
            <div class="card-body">
                ...
                <table id="kt_datatable_horizontal_scroll" class="table align-middle table-striped table-row-bordered gy-3 gs-7 ajax_datatable">
                    ...
                    <tr class="text-start text-dark fw-bolder fs-7 text-uppercase gs-0">
                        ...
                        <th class="min-w-100px text-center">Almacen</th>
                        <th class="text-center">Categoria</th>
                        <th class="min-w-100px text-center">IMAQ 1</th>
                        <th class="min-w-100px text-center">IMAQ 2</th>
...
@endsection
@push('scripts')
    <script type="text/javascript" src="{{  URL::asset ('js/admin/warehouseimaqone/inventory/products.js?v='.rand())  }}"></script>
@endpush
