...
<div id="kt_aside" class="aside" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
                    ...
                    <div class="me-n2">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                            ...
                            <div class="menu-item px-5">
                                <a href="javascript:;" class="menu-link px-5">Mi perfil</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu separator-->
                            <div class="separator my-2"></div>
    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y px-2 my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="{default: '#kt_aside_toolbar, #kt_aside_footer', lg: '#kt_header, #kt_aside_toolbar, #kt_aside_footer'}" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="5px">
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                ...
                {{-- INICIA ALMACEN IMAQ NUEVA ACTUALIZACION--}}
                @hasanyrole('developer|almacenimaq')
                <!--begin:Menu item-->
                <div class="menu-item pt-5">
                    <!--begin:Menu content-->
                    <div class="menu-content">
                        <span class="menu-heading fw-bold text-uppercase fs-7">Almacen IMAQ 1</span>
                    </div>
                    <!--end:Menu content-->
                </div>
                <!--end:Menu item-->
                <!--begin:Menu item-->
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ setOpen('imaq-products-inventory') }}">
                    <!--begin:Menu link-->
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{ setActive('imaq-products-inventory.index') }}" href="{{ route('imaq-products-inventory.index') }}">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{ setActive('imaq-products-inventory.create') }}" href="{{ route('imaq-products-inventory.create') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                ...
                <!--end:Menu item-->
                <!--begin:Menu item-->
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ setOpen('catalogimaq') }}">
                    <!--begin:Menu link-->
                    <span class="menu-link">
                        <span class="menu-icon">
                ...
                {{-- INICIA VENTAS --}}
                @hasanyrole('developer|sales|superadmin')
                <!--begin:Menu item-->
                <div class="menu-item pt-5">
                    <!--begin:Menu content-->
                    <div class="menu-content">
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ setOpen('productos.mapro') }}">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{ setActive('productos.mapro.historial') }}" href="{{ route('productos.mapro.historial') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Productos eliminados</span>
                            </a>
                            <!--end:Menu link-->
                        </div>
                        <!--end:Menu item-->
                ...
                <!--end:Menu item-->
                <!--begin:Menu item-->
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ setOpen('productosmapro') }}">
                    <!--begin:Menu link-->
                    <span class="menu-link">
                        <span class="menu-icon">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{ setActive('productosmapro.index') }}" href="{{ route('productosmapro.index') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Productos</span>
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{ setActive('productosmapro.create') }}" href="{{ route('productosmapro.create') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                ...
                <!--end:Menu item-->
                <!--begin:Menu item-->
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ setOpen('ordersmapro') }}">
                    <!--begin:Menu link-->
                    <span class="menu-link">
                        <span class="menu-icon">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{ setActive('ordersmapro.index') }}" href="{{ route('ordersmapro.index') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Nuevos pedidos</span>
                            </a>
                            <!--end:Menu link-->
                        </div>
                        <!--end:Menu item-->
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{ setActive('ordersmapro.completed') }}" href="{{ route('ordersmapro.completed') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <span class="menu-link">
                        <span class="menu-icon">
                            <i class="fa-solid fa-up-down fs-3"></i>
                        </span>
                        <span class="menu-title">Entradas y Salidas</span>
                        <span class="menu-arrow"></span>
                    </span>
                    <!--end:Menu link-->
                    <!--begin:Menu sub-->
                ...
                <div class="menu-item">
                    ...
                    <a class="menu-link" href="javascript:;">
                        <span class="menu-icon">
                            <img src="{{  asset('metronic/assets/media/usuario.gif')  }}" alt="" width="24" height="24">
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ setActive('business.index') }}" href="{{ route('business.index') }}">
                        <span class="menu-icon">
                ...
                {{-- INICIA CLIENTES --}}
                @hasanyrole('developer|customer')
                <!--begin:Menu item-->
                <div class="menu-item pt-5">
                    <!--begin:Menu content-->
                    <div class="menu-content">
                        <span class="menu-heading fw-bold text-uppercase fs-7">Clientes</span>
                    </div>
                    <!--end:Menu content-->
                </div>
                <!--end:Menu item-->
                ...
                <div class="menu-item">
                    ...
                    <a class="menu-link" href="javascript:;">
                        ...
                        <span class="menu-title">Próximos eventos</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                <!--end:Menu item-->
                ...
                <div class="menu-item">
                    ...
                    <a class="menu-link" href="javascript:;">
                        ...
                        <span class="menu-title">Planes de Membresía</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                <!--end:Menu item-->
                ...
                <div class="menu-item pt-5">
                    <!--begin:Menu content-->
                    <div class="menu-content">
                        <span class="menu-heading fw-bold text-uppercase fs-7">Cotizacion Mi Marca</span>
                    </div>
                    <!--end:Menu content-->
                </div>
                <!--end:Menu item-->
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ setActive('formimaq.index') }}" href="{{ route('formimaq.index') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/abstract/abs014.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ setActive('formservices.index') }}" href="{{ route('formservices.index') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/abstract/abs014.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="menu-title">Lista de Servicios</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                <!--end:Menu item-->
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ setActive('formlines.index') }}" href="{{ route('formlines.index') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/abstract/abs014.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="menu-title">Lista de Linea de productos</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                <!--end:Menu item-->
    ...
    <div class="aside-footer flex-column-auto py-5" id="kt_aside_footer">
        <a href="javascript:;" class="btn btn-custom btn-primary w-100" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss-="click" title="Tienda Online">
            <span class="btn-label">www.maproderm.com</span>
