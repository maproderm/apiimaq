        ...
        <div class="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
            ...
            <div class="d-flex align-items-stretch overflow-auto pt-3 pt-lg-0">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Label-->
                    <span class="fs-7 fw-bold text-gray-700 pe-4 text-nowrap d-none d-xxl-block">Odernar por:</span>
                    <!--end::Label-->
                    <!--begin::Select-->
                    <select class="form-select form-select-sm form-select-solid w-100px w-xxl-125px" data-control="select2" data-placeholder="Latest" data-hide-search="true">
                        <option value=""></option>
                        <option value="1" selected="selected">Reciente</option>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="d-flex align-items-center">
                            <!--begin::Menu- wrapper-->
                            <a href="{{ route('pedidos.index') }}" class="btn btn-sm btn-icon btn-icon-danger btn-active-icon-primary">
                        ...
                        <div class="d-flex align-items-center">
                            <!--begin::Menu- wrapper-->
                            <a href="{{ route('ventas.create') }}" class="btn btn-sm btn-icon btn-icon-success btn-active-icon-primary">
                                <i class="bi bi-cart-plus-fill fs-3"></i>
                            </a>
                            <!--end::Menu wrapper-->
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            <!--begin::Menu- wrapper-->
                            <a href="{{ route('dealers.index') }}" class="btn btn-sm btn-icon btn-icon-info btn-active-icon-primary">
                                {{-- <i class="bi bi-cart-plus-fill fs-3"></i> --}}
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Menu toggle-->
                    <a href="#" class="btn btn-sm btn-icon btn-icon-warning btn-active-icon-primary" data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
