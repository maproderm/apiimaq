    ...
    let updateCategory = function () {
        $(document).on('click','.update_category',function(){
            ...
            $.ajax({
                ...
                if(!response.error){
                    $('#edit_category_imaq_modal').empty();
                    $('#edit_category_imaq_modal').append(response.render);
                    $('#kt_modal_update_category_imaq').modal('show');
                } else {
